...
public class Serie {
	...
	public Serie(long id, String name, String picture, String text, List<Season> listOfSeasons) {
		super();
		this.id = id;
		this.name = name;
	...
	public Serie(long id) {
		...
		if (id == 1) {
			...
			this.text = "Die US-Serie The Walking Dead ist eine Adaption der gleichnamigen Comicbuchreihe von Robert Kirkman. Darin geht es um eine Gruppe von Menschen, die nach der Apokalypse als letzte Überlebende in einer Welt bestehen muss, die von Zombies bevölkert wird. Im Mittelpunkt der Serie steht der Polizist Rick Grimes, der für sich und seine Mitstreiter eine dauerhafte sichere Zuflucht sucht und die zerstörte Gesellschaft neu aufbauen möchte.";
			...
			this.name = "Serie" + id;
			this.text = "Keine Ahnung, voll blöd. Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla Bla";
		}
	...
	public String toString() {
		String sOutput;
		sOutput = "Serie [id=" + id + ", name=" + name + ", picture=" + picture + "]";
		sOutput += "Season(";
